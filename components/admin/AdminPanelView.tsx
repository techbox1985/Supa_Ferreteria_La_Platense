    ...
    return (
        <div className="flex h-[calc(100vh-80px)]">
            <aside className="w-64 bg-white p-4 flex-col shadow-lg z-10 space-y-2 overflow-y-auto">
                ...
                <AdminNavButton label="Bajo Stock" iconPath="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126z" isActive={currentAdminView === 'low-stock-admin'} onClick={() => setCurrentAdminView('low-stock-admin')} />
