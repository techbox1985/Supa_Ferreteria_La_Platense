    ...
    return (
        <div className="flex h-[calc(100vh-80px)]">
            <aside className="w-64 bg-white p-4 flex-col shadow-lg z-10 space-y-2 overflow-y-auto">
                ...
                <AdminNavButton label="Bajos de Stock" iconPath="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126z" isActive={currentAdminView === 'low-stock-admin'} onClick={() => setCurrentAdminView('low-stock-admin')} />
                <AdminNavButton label="Edición Rápida" iconPath="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.388 1.62a15.998 15.998 0 00-1.622-3.385m-5.043-.025a15.998 15.998 0 01-3.388-1.621m-1.622 3.385a15.998 15.998 0 01-1.622-3.385m5.043.025a15.998 15.998 0 00-3.388-1.622m-1.622 3.385a15.998 15.998 0 00-1.622-3.385" isActive={currentAdminView === 'quick-edit'} onClick={() => setCurrentAdminView('quick-edit')} />
                <AdminNavButton label="Ingreso de Stock" iconPath="M9 13.5l3 3m0 0l3-3m-3 3v-6m1.06-4.19l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" isActive={currentAdminView === 'stock-entry'} onClick={() => setCurrentAdminView('stock-entry')} />
                ...
                <div className="pt-2 mt-2 border-t">
                 ...
                 <AdminNavButton label="Historial de Ventas" iconPath="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" isActive={currentAdminView === 'sales-history'} onClick={() => setCurrentAdminView('sales-history')} />
